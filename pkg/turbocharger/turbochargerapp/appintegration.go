...
// if deployment specifies TURBOCHARGER_MANIFEST_ID, all requests to a prefix (e.g. /static/...)
...
// helper for making a static file server with Turbocharger advertising enabled
